...
void main() {
  runApp(const AppCandelChart());
}

class AppCandelChart extends StatefulWidget {
  const AppCandelChart({Key? key}) : super(key: key);

  @override
  _AppCandelChartState createState() => _AppCandelChartState();
}

class _AppCandelChartState extends State<AppCandelChart> {
